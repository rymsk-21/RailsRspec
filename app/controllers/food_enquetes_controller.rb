  ...
  def create
    ...
    respond_to do |format|
      if @food_enquete.save
        format.html { redirect_to food_enquete_url(@food_enquete), notice: "Food enquete was successfully created." }
  ...
  def update
    respond_to do |format|
      if @food_enquete.update(food_enquete_params)
        format.html { redirect_to food_enquete_url(@food_enquete), notice: "Food enquete was successfully updated." }
