class GymEnquetesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @gym_enquete.save
        format.html { redirect_to gym_enquete_url(@gym_enquete), notice: "Gym enquete was successfully created." }
  ...
  def update
    respond_to do |format|
      if @gym_enquete.update(gym_enquete_params)
        format.html { redirect_to gym_enquete_url(@gym_enquete), notice: "Gym enquete was successfully updated." }
